      ...
      <div className={styles.wideImage}>
        ...
        <div className={styles.imageTextContainer}>
            <div className = {styles.textLeft}>
              ...
              <p> There’s a bunch of ways to come out and volunteer, labor trade or donate to the cause ~ come hang with us!</p>
              <button>Get Involved</button>
            </div>
            <div>
            <Image className={styles.imageright}
        ...
        <div className={styles.imageTextContainer}>
          <div>
            ...
            <div className={styles.textRight}>
              <h2 >Our Mission</h2>
              <p >To create a sustainable farming community rooted in loving and nurturing our relationships with each other and the land</p>
              <h2 >Our Vision</h2>
              <p > We are cultivating a space of joy and possibility where we live with intention, honor our differences and work together in reciprocal connection with the Earth</p>
